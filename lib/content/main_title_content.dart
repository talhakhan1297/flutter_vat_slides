...
class _MainTitleContentState extends State<MainTitleContent>
  ...
  late AnimationController _flutterLiveController;
  late Animation<Offset> _flutterLiveSlideTransition;
  late Animation<double> _flutterLiveScaleTransition;
  late Animation<double> _flutterLiveGlitchAnimation;
...
class _WelcomeCellState extends State<WelcomeCell>
  ...
  Widget build(BuildContext context) {
    final glitchAnimation = Tween(begin: 1.0, end: 0.0).animate(CurvedAnimation(
        ...
        curve: const Interval(0.35, 0.352, curve: SawTooth(1))));
    ...
    const minRangeValue = 0.37;
    const maxRangeValue = 0.47;
    for (int i = 0; i < letterArray.length; i++) {
      ...
      const endingValueForBlinkAnimation = 2;
