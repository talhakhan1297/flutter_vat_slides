  ...
  TeamPhotosContent(
      ...
      : columnCount = contentMap['column_count'],
        ...
        bgColors = List<Color>.generate((contentMap['colors'] as List).length,
            (index) {
          return color_utils.colorFromString(
            contentMap['colors'][index],
            errorColor: const Color(0xFF1B364F),
          );
        }),
        super(key: key);
...
class _TeamPhotosContentState extends State<TeamPhotosContent> {
  ...
  late _TeamPhotosImagePathSupplier _teamPhotosImagePathSupplier;
  @override
  void initState() {
    super.initState();
...
class _TeamPhotoImageState extends State<TeamPhotoImage>
  ...
  final String fileRoot = "assets/example_presentation/external_files";
  late AnimationController _animationController;
  late Timer _updateTimer;
  late String _nextImagePath;
  @override
  void initState() {
