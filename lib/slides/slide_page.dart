...
import 'package:presentation/content/slide_content_factory.dart';
...
import 'package:presentation/content/animated_content_widget.dart';
import 'package:flutter/material.dart';

class SlidePageController {
  late _SlidePageControllerListener listener;
...
class SlidePageState extends State<SlidePage>
  ...
  late ValueNotifier<int> _slideAdvancementNotifier;
            ...
            child: Stack(
              children: List<Widget>.generate(
                ...
                (index) {
                  ...
                  int step = (contentMap['advancement_step'] as int?)
                          ?.clamp(0, widget.slide.advancementCount) ??
                      0;
                  if (_slideAdvancementCount < step) {
                    return Container();
                  }
  ...
  Widget _generateContent(double slideWidth, double slideHeight, Map contentMap,
    ...
    if (contentMap.containsKey('animation')) {
      contentWidget = AnimatedContentWidget(
        ...
        completeAnimation: widget.isPreview,
      );
    }
